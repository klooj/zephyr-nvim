...
function zephyr.load_plugin_syntax()
    local plugin_syntax = {
        ...
        CursorWord1 = {bg = zephyr.cursor_bg},
...
function zephyr.get_zephyr_color() return zephyr end
...
function zephyr.colorscheme()
    ...
    for group, colors in pairs(syntax) do zephyr.highlight(group, colors) end
